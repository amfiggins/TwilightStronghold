...
## 2024-05-18 - Caching UI State in RenderStepped
**Learning:** Unconditionally calling `TweenService:Create` or updating string properties inside high-frequency per-frame loops (`RenderStepped`) causes severe garbage collection and Lua-C boundary overhead, leading to micro-stutters.
