...
## 2026-06-24 - Optimize RenderStepped String Allocation
**Learning:** Unconditionally calling `TweenService:Create` or updating string properties (like `TextLabel.Text`) inside high-frequency per-frame loops (like `RenderStepped`) causes severe garbage collection and Lua-C boundary overhead.
