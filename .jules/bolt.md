...
## 2024-06-05 - RenderStepped UI Update Overhead
**Learning:** In Roblox Luau, unconditionally calling `TweenService:Create` or updating string properties inside high-frequency per-frame loops (like `RenderStepped`) causes severe garbage collection and Lua-C boundary overhead.
