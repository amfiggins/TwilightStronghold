...
## 2025-02-15 - Dynamic Cross-Platform Instructions
**Learning:** Hardcoding "Press SPACE" alienates mobile and console users.
**Action:** Default to platform-agnostic phrasing ("Hold to align") and dynamically update instruction text based on `UserInputService.InputBegan` to ensure relevant guidance across all devices.
