...
## 2027-06-15 - Input Device Mixing & Stuck States
**Learning:** When users mix input methods (e.g., using a mouse to hover, then a gamepad to navigate away), UI elements with shared hover/selection state variables can get permanently stuck in a highlighted state.
