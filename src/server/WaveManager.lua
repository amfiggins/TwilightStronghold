...
function WaveManager.SpawnEnemy(difficulty)
    ...
    task.spawn(function()
        ...
        -- RaycastParams for line-of-sight checks
        ...
        while enemy.Parent and humanoid and humanoid.Health > 0 do
            ...
            if targetPlayer and targetPlayer.Character and targetPlayer.Character.PrimaryPart then
                ...
                -- Optimization: Raycast check for short-range direct movement (< 30 studs)
                if distance < 30 then
                    local result = workspace:Raycast(rootPart.Position, direction, rayParams)

                    -- If result is nil (no obstruction) or hits the target player, move directly
