    ...
    task.spawn(function()
        ...
        while enemy.Parent and humanoid and humanoid.Health > 0 do
            ...
            if targetPlayer and targetPlayer.Character and targetPlayer.Character.PrimaryPart then
                ...
                -- Optimization: Throttle updates based on distance (using squared distances: 10000, 2500)
                ...
                -- Optimization: Use direct movement if close and clear Line of Sight (30 squared = 900)
                if distSq < 900 then
