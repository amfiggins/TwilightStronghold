...
function WaveManager.SpawnEnemy(difficulty)
    ...
    task.spawn(function()
        ...
        -- Optimization: Reuse RaycastParams to avoid allocation in loop
        ...
        while enemy.Parent and humanoid and humanoid.Health > 0 do
            ...
            if targetPlayer and targetPlayer.Character and targetPlayer.Character.PrimaryPart then
                ...
                -- Optimization: Raycast check for direct Line of Sight
                -- If we can see the player and are relatively close, skip expensive ComputeAsync
                local canSee = false
                if distance < 30 then
