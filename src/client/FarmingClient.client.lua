...
local function openSelector(plot)
    ...
    local function updateCloseBtnState(isActive)
        closeBtn.TextColor3 = isActive and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(255, 255, 255)
    end
    ...
    if #ownedSeeds == 0 then
        ...
        for _, seed in ipairs(ownedSeeds) do
            ...
            local function updateBtnState(isActive)
                btn.BackgroundColor3 = isActive and Color3.fromRGB(80, 100, 80) or Color3.fromRGB(60, 60, 60)
            end
