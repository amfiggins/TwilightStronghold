...
local function openSelector(plot)
    ...
    local function updateCloseBtnState(hovered)
        closeBtn.TextColor3 = hovered and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(255, 255, 255)
    end
    ...
    if #ownedSeeds == 0 then
        ...
        for _, seed in ipairs(ownedSeeds) do
            ...
            local function updateBtnState(hovered)
                btn.BackgroundColor3 = hovered and Color3.fromRGB(80, 100, 80) or Color3.fromRGB(60, 60, 60)
            end
