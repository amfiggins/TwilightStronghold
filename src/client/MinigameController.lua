...
function MinigameController.Start(callback)
    ...
    connection = RunService.RenderStepped:Connect(function(dt)
        ...
        if barStart < targetEnd and barEnd > targetStart then
            ...
            bar.BackgroundColor3 = Color3.fromRGB(100, 255, 100) -- Visual feedback: Green when overlapping
        else
            progress = math.max(0, progress - (DECAY_RATE * dt))
            bar.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Back to white when not
        end
