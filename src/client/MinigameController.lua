...
function MinigameController.Start(callback)
    ...
    connection = RunService.RenderStepped:Connect(function(dt)
        ...
        -- Update UI
        -- Optimization: Replaced UDim2.new with UDim2.fromScale in RenderStepped hot loop
        -- Expected Impact: Skips parsing of unused offset properties, reducing per-frame overhead on the main thread
