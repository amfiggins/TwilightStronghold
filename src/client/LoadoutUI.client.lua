...
local refreshTweenInfo = TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1)
local refreshRotationTween = TweenService:Create(refreshBtn, refreshTweenInfo, {Rotation = 360})
