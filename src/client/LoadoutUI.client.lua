...
local function populateLoadout()
    ...
    currentRefreshTween = TweenService:Create(refreshBtn, tweenInfo, { Rotation = 360 })
    currentRefreshTween:Play()
    ...
    if not success then
        ...
        if currentRefreshTween then
            currentRefreshTween:Cancel()
