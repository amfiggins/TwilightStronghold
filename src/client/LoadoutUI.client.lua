...
-- Refresh Container (Stable for Tooltip)
...
refreshTooltip.Parent = refreshContainer -- Parent to container so it aligns properly but doesn't rotate

-- Refresh Animation Tween
local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1)
local refreshTween = TweenService:Create(refreshBtn, tweenInfo, {Rotation = 360})
