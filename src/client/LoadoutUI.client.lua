...
openBtn.MouseEnter:Connect(function() updateOpenBtnState(true) end)
openBtn.MouseLeave:Connect(function() updateOpenBtnState(false) end)
openBtn.SelectionGained:Connect(function() updateOpenBtnState(true) end)
openBtn.SelectionLost:Connect(function() updateOpenBtnState(false) end)
