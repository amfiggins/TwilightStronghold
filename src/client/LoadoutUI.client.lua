...
openBtn.MouseEnter:Connect(function() updateOpenState(true) end)
openBtn.MouseLeave:Connect(function() updateOpenState(false) end)
openBtn.SelectionGained:Connect(function() updateOpenState(true) end)
openBtn.SelectionLost:Connect(function() updateOpenState(false) end)
