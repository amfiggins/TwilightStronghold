...
-- Main HUD Toggle Button (Micro-UX: Discoverability for mobile/mouse users)
local openBtn = Instance.new("TextButton")
openBtn.Name = "OpenLoadoutBtn"
openBtn.Size = UDim2.fromOffset(100, 40)
...
local function updateOpenBtnState(isHovered)
...
local function toggleLoadoutVisibility()
...
openBtn.MouseButton1Click:Connect(toggleLoadoutVisibility)
closeBtn.MouseButton1Click:Connect(toggleLoadoutVisibility)
