...
-- ⚡ Bolt: Cache UI values to avoid unconditionally calling TweenService:Create and updating Text
-- inside a high-frequency RenderStepped loop, which causes severe GC and Lua-C boundary overhead.
