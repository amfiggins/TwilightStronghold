...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        if ratio ~= lastHealthRatio then
            ...
            -- ⚡ Bolt: Only create tweens when health actually changes to avoid severe GC overhead on every frame
    ...
    if newTimerText ~= lastTimerText then
        ...
        -- ⚡ Bolt: Cache text updates to avoid unnecessary string property assignments
