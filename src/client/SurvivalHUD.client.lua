...
-- ── Update helpers ────────────────────────────────────────────────────────
-- ⚡ Bolt: Cache TweenInfo to avoid recreating it on every bar update
...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        -- ⚡ Bolt: Cache health ratio to avoid Tween creation overhead in RenderStepped
    ...
    -- ⚡ Bolt: Cache integer seconds to prevent string allocation and UI update overhead on every frame
