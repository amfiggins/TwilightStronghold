...
-- ⚡ Bolt: Caching previous state to prevent high-frequency TweenService allocations and string updates
...
RunService.RenderStepped:Connect(function(dt)
    ...
    local currentText = formatTime(phaseState.timeRemaining)
