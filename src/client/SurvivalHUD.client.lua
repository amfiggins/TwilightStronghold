...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        -- ⚡ Bolt: Cache health ratio against a threshold to prevent redundant Tween creations in high-frequency loop
    ...
    local seconds = math.floor(phaseState.timeRemaining)
    -- ⚡ Bolt: Cache integer seconds to avoid string formatting and UI property updates every frame
