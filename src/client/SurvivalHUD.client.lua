...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        -- ⚡ Bolt: Cache health ratio and timer text to avoid Tween creation and string property updates on every frame
    ...
    if newTimeText ~= lastTimerText then
        lastTimerText = newTimeText
