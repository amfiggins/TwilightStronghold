...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        if healthRatio ~= lastHealthRatio then
            -- ⚡ Bolt: Cache health ratio to avoid creating a new Tween every frame
    ...
    if newTimerText ~= lastTimerText then
        -- ⚡ Bolt: Cache timer text to avoid redundant string formatting and UI property assignments every frame
