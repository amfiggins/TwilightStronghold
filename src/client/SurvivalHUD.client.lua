...
RunService.RenderStepped:Connect(function(dt)
    ...
    if humanoid then
        ...
        -- ⚡ Bolt: Cache health ratio to avoid creating a Tween every frame if health hasn't changed
    ...
    -- ⚡ Bolt: Cache timer text to avoid setting Text property every frame
